...
import { ServiceListResults } from '../components/sidemenu/sidemenu-list-results';
import { ServiceListToolbar } from '../components/sidemenu/sidemenu-list-toolbar';
import { ServiceModal } from '../components/sidemenu/modal';
...
const Page = () => {
  ...
  const fetchData = () => {
    ...
    const url = `${API_BASE_URL}sidemenu/list_sidemenu`;
  ...
  const onDelete = (serviceId) => {
    ...
    const url = `${API_BASE_URL}sidemenu/delete_sidemenu/${serviceId}`;
    axios.delete(url, {
      headers: headers,
    }).then(res => {
